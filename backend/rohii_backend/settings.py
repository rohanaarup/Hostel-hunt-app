...
ROOT_URLCONF = 'rohii_backend.urls'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '60/minute',  # Anonymous API calls
        'user': '300/minute', # Authenticated API calls
    },
    'DEFAULT_RENDERER_CLASSES': (
        'rest_framework.renderers.JSONRenderer',
    ),
    'EXCEPTION_HANDLER': 'rohii_backend.exceptions.custom_exception_handler',
}
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='ROHII Hostel Hunt <no-reply@rohii.com>')
